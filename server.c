...
void *communicate (void *message)
{
	...
	if (voter_found == 1)
	{
		...
		strcpy(server_message, "Welcome Voter to our Online Voting System. Nice to see you :)");
		...
		if (vote_casted == 0)
		{
			...
			strcpy(candidates, "Following are the list of our Candidates and their Poll symbols: \n");
			...
			//Check for Vote Symbol matches or not
			
			char symbolCheck[100];
			strcpy(symbolCheck, client_message);
			
			char *newlineSymbol;
			newlineSymbol = strchr(symbolCheck,'\n');
			if(newlineSymbol != NULL)
				*newlineSymbol = '\0';
			
			if (strcmp(symbolCheck, "Bat") == 0 ||  strcmp(symbolCheck, "Tiger") == 0 ||  strcmp(symbolCheck, "Arrow") == 0 ||  strcmp(symbolCheck, "Book") == 0 ||  strcmp(symbolCheck, "Lantern") == 0 ||  strcmp(symbolCheck, "Kite") == 0 ||  strcmp(symbolCheck, "Tractor") == 0 ||  strcmp(symbolCheck, "Motorcycle") == 0 ||  strcmp(symbolCheck, "Scale") == 0){
				...
				strcpy(server_message, "Your Vote symbol did not match. You did not enter correct symbol. \nNice to interact with you :)");
